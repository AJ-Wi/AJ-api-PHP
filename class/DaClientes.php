...
class DaClientes
{
    ...
    public static function getAll()
    {
        ...
        try {
            ...
            if (!$response) {return $_response->message_400("Registros NO encontrados");}
    ...
    public static function getByNombre($value)
    {
        $conn = new DbConnect();
        $_response = new Response();
        $sql = $conn->prepare('SELECT * FROM ' . self::TABLA . ' WHERE nombre LIKE :nombre');
